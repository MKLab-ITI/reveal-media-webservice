	...
	public static void main( String[] arg ) throws IOException, JSAPException {
		final SimpleJSAP jsap = new SimpleJSAP( GZIPIndexer.class.getName(), "Computes and stores a quasi-succinct index for a compressed archive.",
				new Parameter[] {
					...
					new UnflaggedOption( "index", JSAP.STRING_PARSER, JSAP.NO_DEFAULT, JSAP.NOT_REQUIRED, JSAP.GREEDY, "A serialized LongBigList of pointers to the records in the archive." ),
				}
		);
