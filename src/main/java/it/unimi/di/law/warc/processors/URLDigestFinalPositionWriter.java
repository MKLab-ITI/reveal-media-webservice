...
public class URLDigestFinalPositionWriter implements Writer<WarcRecord> {
	...
	public URLDigestFinalPositionWriter( final String storeIndex, final String repeatedSetFile ) throws ClassNotFoundException, IOException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException, NoSuchAlgorithmException {		
