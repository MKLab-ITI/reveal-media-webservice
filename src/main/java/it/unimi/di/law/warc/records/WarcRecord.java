...
public interface WarcRecord {
	 ...
	 * @return the header, or <samp>null</samp> if the header is not present.
	 */
	...
	/** 
	 * Returns the <samp>WARC-Record-ID</samp> header.
	 * 
	...
	/** 
	 * Returns the <samp>WARC-Type</samp> header.
	 * 
	 * @return the record type.
	 * @throws IllegalStateException in case the header (which is mandatory) is not present.
	 */
	...
	/** 
	 * Returns the <samp>WARC-Date</samp> header.
	 * 
	...
	/** 
	 * Returns the WARC <samp>Content-Length</samp> header.
	 * 
	...
	// Convenience getter for non-manadtory headers
	
	/** 
	 * Returns the <samp>WARC-Target-URI</samp> header.
	 * 
